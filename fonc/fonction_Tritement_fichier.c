...
if(!flot){
    printf("pb d'ouverture de fichier 1\n");
    getch();
    exit(-1);
}
...
flot=fopen(JOUEURS,"rb");
if(!flot){
    printf("pb d'ouverture de fichier 2\n");
    getch();
    exit(-1);
}
...
if(!flot){
    printf("pb d'ouverture de fichier 3\n");
    getch();
    exit(-1);
}
flot2=fopen("dataDeJoueur.dat","rb");
if(!flot2){
    printf("pb d'ouverture de fichier 4\n");
    getch();
    exit(-1);
}
joueur A;
...
if(!flot){
    printf("pb d'ouverture de fichier 5\n");
    getch();
    exit(-1);
}
while (fread(&A,sizeof(A),1,flot))
...
flot=fopen("dataDeJoueur.dat","rb");
if(!flot){
    printf("pb d'ouverture de fichier 6\n");
    getch();
    exit(-1);
}
...
if(!flot){
    printf("pb d'ouverture de fichier 7\n");
    getch();
    exit(-1);
}
fwrite(&A,sizeof(A),1,flot);
...
flot=fopen("dataDeJoueur.dat","rb");
if(!flot){
    printf("pb d'ouverture de fichier 8\n");
    getch();
    exit(-1);
}
while (fread(&B,sizeof(B),1,flot))
...
char N[100]="fonc/jeusauvgarde/";
strcat(N,A.usrname);
FILE *flot;
flot=fopen(N,"wb");
if(!flot){
    printf("pb d'ouverture de fichier 9\n");
    getch();
    exit(-1);
}
int i,j;
...
flot=fopen(N,"rb");
if(!flot){
    printf("pb d'ouverture de fichier 10\n");
    getch();
    exit(-1);
}
