...
Surface1=IMG_Load("fonc/image/Login.png");
Surface=IMG_Load("fonc/image/image1.jpg");
SurfaceSign_in=IMG_Load("fonc/image/Sign_in.png");
SurfaceSign_up=IMG_Load("fonc/image/Sign_up.png");
Surfaceverfie=IMG_Load("fonc/image/message.png");
...
USER=TTF_OpenFont("fonc/font.ttf",15);
SDL_Surface *icon=NULL;
icon=IMG_Load("fonc/image/icon.png");
...
SDL_Renderer *Game(SDL_Window *win,SDL_Renderer *renderer,joueur player)
{
    ...
    SDL_Texture *text2joueur=loadImage("fonc/image/2joueur.png",renderer);
    SDL_Texture *textcolorblanc=loadImage("fonc/image/colorblach.png",renderer);
    SDL_Texture *textcolornoire=loadImage("fonc/image/colornoire.png",renderer);
    SDL_Texture *textdifficle=loadImage("fonc/image/Difficile.png",renderer);
    SDL_Texture *textfacile=loadImage("fonc/image/facile.png",renderer);
    SDL_Texture *textliste=loadImage("fonc/image/paper.png",renderer);
    SDL_Texture *textmove=loadImage("fonc/image/history.png",renderer);
    SDL_Texture *textmoyen=loadImage("fonc/image/moyen.png",renderer);
    SDL_Texture *textrecm=loadImage("fonc/image/refresh.png",renderer);
    SDL_Texture *text10top=loadImage("fonc/image/top-three.png",renderer);
    SDL_Texture *I_joueur2=loadImage("fonc/image/idee_j.png",renderer);
    SDL_Texture *I_joueur=loadImage("fonc/image/idee_j2.png",renderer);
    SDL_Texture *I_Machi=loadImage("fonc/image/en-pensant.png",renderer);
    SDL_Texture *VSB=loadImage("fonc/image/N_vs_B.png",renderer);
    SDL_Texture *VSN=loadImage("fonc/image/B_vs_N.png",renderer);
    SDL_Texture *T_UPload=loadImage("fonc/image/upload.png",renderer);
    SDL_Texture *T_download=loadImage("fonc/image/download.png",renderer);
    SDL_Texture *T_undo=loadImage("fonc/image/undo.png",renderer);
    SDL_Texture *T_ScoreB=NULL;
    SDL_Texture *T_ScoreN=NULL;
    SDL_Texture *T_Gameover=loadImage("fonc/image/gameover.png",renderer);
    ...
    //fin
    //IMG_Load
    SurfaceMain=IMG_Load("fonc/image/bg.jpg");
    
    Surfacetab=IMG_Load("fonc/image/board.png");
    Noire=IMG_Load("fonc/image/noire.png");
    Blanc=IMG_Load("fonc/image/blanc.png");
    Point=IMG_Load("fonc/image/hint.png");
  ...
  int bloq1=0,bloq=0,afficheTop=0,affichemove=0,nivaux=0,win1=1,win2=0,win3=0,Boll=1,actuliseTOP=1,actulisemove=0,update_score=1,a=0,new_score=player.score;
   init:  
    ...
    USER=TTF_OpenFont("fonc/font.ttf",15);
    font_S=TTF_OpenFont("fonc/Sansation-Italic.ttf",36);  
    SDL_Surface *S_text;
    SDL_Texture *T_text;
